...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TerminalPageModule", function() { return TerminalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__terminal__ = __webpack_require__(397);
...
var TerminalPageModule = /** @class */ (function () {
    function TerminalPageModule() {
    }
    TerminalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__terminal__["a" /* TerminalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__terminal__["a" /* TerminalPage */]),
            ],
            // for the obscure ion-textbox
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["i" /* CUSTOM_ELEMENTS_SCHEMA */]]
        })
    ], TerminalPageModule);
    return TerminalPageModule;
}());
...
var BufferSet_1 = __webpack_require__(398);
var CompositionHelper_1 = __webpack_require__(401);
var EventEmitter_1 = __webpack_require__(373);
var Viewport_1 = __webpack_require__(402);
var Clipboard_1 = __webpack_require__(403);
var EscapeSequences_1 = __webpack_require__(379);
var InputHandler_1 = __webpack_require__(404);
var Parser_1 = __webpack_require__(405);
var Renderer_1 = __webpack_require__(406);
var Linkifier_1 = __webpack_require__(408);
var SelectionManager_1 = __webpack_require__(409);
var CharMeasure_1 = __webpack_require__(412);
var Browser = __webpack_require__(383);
var Mouse_1 = __webpack_require__(382);
var BufferLine_1 = __webpack_require__(384);
...
Terminal.loadAddon = function (addon, callback) {
    if (true) {
        return __webpack_require__(413)("./" + addon + '/' + addon);
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var Generic_1 = __webpack_require__(410);
...
(function (attach) {
  if (true) {
     ...
     */
    module.exports = attach(__webpack_require__(372));
  } else if (typeof define == 'function') {
    /*
...
(function (fit) {
  if (true) {
     ...
     * CommonJS environment
     */
    module.exports = fit(__webpack_require__(372));
  } else if (typeof define == 'function') {
    /*
     * Require.js is available
     */
...
(function (fullscreen) {
  if (true) {
     ...
     * CommonJS environment
     */
    module.exports = fullscreen(__webpack_require__(372));
  } else if (typeof define == 'function') {
    /*
     * Require.js is available
     */
...
Object.defineProperty(exports, "__esModule", { value: true });
var SearchHelper_1 = __webpack_require__(380);
(function (addon) {
    if ('Terminal' in window) {
        addon(window.Terminal);
    }
    else if (true) {
        module.exports = addon(__webpack_require__(372));
    }
    else if (typeof define == 'function') {
        define(['../../xterm'], addon);
    }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TerminalPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__device_device__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_providers__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_xterm__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_xterm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_xterm__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_xterm_dist_addons_fit_fit__ = __webpack_require__(417);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_xterm_dist_addons_fit_fit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_xterm_dist_addons_fit_fit__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TerminalPage = /** @class */ (function () {
    function TerminalPage(navCtrl, navParams, events, zone, settings, alertCtrl, ble) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.linechars_echo = false;
        this.linechars_cr = true;
        this.linechars_lf = false;
        this.nativeBLE = __WEBPACK_IMPORTED_MODULE_2__device_device__["a" /* DevicePage */];
        ...
        if (this.peripheral !== undefined) {
            ...
            this.peripheral.data.subscribe(function (data) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_xterm__["loadAddon"]("fit");
        this.term = new __WEBPACK_IMPORTED_MODULE_4_xterm__({
            cursorBlink: true,
            //useStyle: true,
            scrollback: 60,
            rows: 21,
        ...
        this.term.on("key", function (key, ev) {
            ...
            _this.ble.sendText(key, _this.peripheral);
        });
        // the settings page changed the UART settings
        // same arguments passed in `events.publish()
        events.subscribe('settings:changed', function (settings) {
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            handler: function () {
                                ...
                                _this.settings.getValue('baudid').then(function (baud) { return _this.ble.setBaudConfig(baud, _this.peripheral); });
                                // then we change the password and group and give it some extra time
                                setTimeout(function () {
                                    _this.settings.getValue('password').then(function (pwd) { return _this.ble.newPassword(pwd, _this.peripheral); });
                                }, 200);
                                setTimeout(function () {
                                    _this.settings.getValue('group').then(function (grp) { return _this.ble.setConfig(grp, _this.peripheral); });
                                }, 500);
                            }
                        }
                    ]
    ...
    TerminalPage.prototype.ionViewDidLoad = function () {
    ...
    TerminalPage.prototype.updateLinechar = function (type) {
        var _this = this;
        this.zone.run(function () {
            // somehow it's required on iOS to have that changed on the screen
            _this.linechars_echo = _this.linechars_echo;
            _this.linechars_cr = _this.linechars_cr;
            _this.linechars_lf = _this.linechars_lf;
            //console.log("linechars changed " + this.linechars_echo );
        });
    };
    // called from button
    TerminalPage.prototype.sendCMD = function () {
        var _this = this;
        //console.log( this.transmit );
        if (this.linechars_echo) {
            // echo to terminal
            this.zone.run(function () {
                _this.term.writeln(_this.transmit);
            });
        }
    ...
    TerminalPage.prototype.startScanning = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var pwd, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.ble.connect(this.gotConfig, this.getDataNote)];
                    case 2:
                        // returns an Observable
                        _a.sent();
                        ...
                        //);
                        return [4 /*yield*/, this.settings.getValue('password').then(function (data) { return pwd = data; })];
                    case 3:
                        // first send password, must do that before read or subscribe to notes
                        //this.settings.getValue( 'password' ).then(
                        //    pwd => this.ble.password( pwd )
                        //);
                        _a.sent();
                        return [4 /*yield*/, this.ble.password(pwd)];
                    case 4:
                        _a.sent();
                        ...
                        return [4 /*yield*/, this.ble.sendText("\0")];
                    case 5:
                        // send null char for connected
                        // REMOVE WHEN WORKING, FIRMWARE BUG, first packet is lost
                        //await this.client.sendText("Hello from Chrome");
                        _a.sent();
                        // set the baud rate
                        this.settings.getValue('baudid').then(function (baud) { return _this.ble.setBaudConfig(baud); });
                        // use local
                        this.uartData
                        ...
                        // error
                        function (e) { return console.log("datastream " + e); }, 
                        // final
                        function () {
                    ...
                    case 6:
                        ...
                        console.log("error connecting " + err_1);
                        this.ble.disconnect();
                        this.isScanning = false;
                        this.isConnected = false;
                        return [3 /*break*/, 7];
    ...
    TerminalPage.prototype.getDataNote = function (o) {
        this.uartData = o;
        console.log("got observable for notes");
    };
    // read characteristic callback
    TerminalPage.prototype.gotConfig = function (event) {
        console.log("got " + new Uint8Array(event.target.value.buffer));
        var group = event.target.value.getUint8(11) + event.target.value.getUint8(12) * 256;
        var baud = event.target.value.getUint8(17);
    ...
    TerminalPage.prototype.disconnect = function () {
        if (this.peripheral !== undefined) {
            // native
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* ViewChild */])('terminal'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* ElementRef */])
    ], TerminalPage.prototype, "terminal", void 0);
    TerminalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'terminal',template:/*ion-inline-start:"/home/vishal/Downloads/SPP-over-GATT-master/src/pages/terminal/terminal.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>GATT Console</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-left (click)="startScanning()" *ngIf="!isScanning&&!isConnected">\n        <ion-icon name="bluetooth"></ion-icon>\n        Scan\n      </button>\n      <button ion-button icon-left (click)="disconnect()" *ngIf="isConnected">\n        <ion-icon name="bluetooth"></ion-icon>\n        Disconnect\n      </button>\n      <button ion-button icon-left (click)="stopScanning()" *ngIf="isScanning">\n        <ion-spinner></ion-spinner>\n        Stop\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n\n\n  <ion-grid>\n    <ion-row>\n      <ion-col col-3>\n        <ion-label>ECHO</ion-label>\n        <ion-checkbox checked="linechars_echo" [(ngModel)]="linechars_echo" (ionChange)="updateLinechar(\'e\')"></ion-checkbox>\n      </ion-col>\n      <ion-col col-3>\n        <ion-label>CR</ion-label>\n        <ion-checkbox checked="linechars_cf" [(ngModel)]="linechars_cr" (ionChange)="updateLinechar(\'c\')"></ion-checkbox>\n      </ion-col>\n      <ion-col col-3>\n        <ion-label>CF</ion-label>\n        <ion-checkbox checked="linechars_lf" [(ngModel)]="linechars_lf" (ionChange)="updateLinechar(\'l\')"></ion-checkbox>\n      </ion-col>\n    </ion-row>\n\n    <ion-row>\n      <ion-input style="background-color: #E0E0E0" type="text" autocapitalize="none" autocorrect="off" placeholder="command line" [(ngModel)]="transmit">\n      </ion-input>\n\n      <button ion-button small item-end outline (click)="sendCMD()" [disabled]="!isConnected">Send</button>\n    </ion-row>\n\n  </ion-grid>\n\n</ion-header>\n\n<ion-content padding>\n  <ion-textbox #terminal></ion-textbox>\n</ion-content>\n\n'/*ion-inline-end:"/home/vishal/Downloads/SPP-over-GATT-master/src/pages/terminal/terminal.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_providers__["b" /* Settings */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_providers__["a" /* Ble */]])
    ], TerminalPage);
    return TerminalPage;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
var CircularList_1 = __webpack_require__(400);
var Buffer = (function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var EscapeSequences_1 = __webpack_require__(379);
var Charsets_1 = __webpack_require__(381);
...
Object.defineProperty(exports, "__esModule", { value: true });
var DomElementObjectPool_1 = __webpack_require__(407);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Mouse = __webpack_require__(382);
var Browser = __webpack_require__(383);
var EventEmitter_1 = __webpack_require__(373);
var SelectionModel_1 = __webpack_require__(411);
var BufferLine_1 = __webpack_require__(384);
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventEmitter_js_1 = __webpack_require__(373);
...
var map = {
	"./attach/attach": 385,
	"./attach/attach.js": 385,
	"./attach/package": 386,
	"./attach/package.json": 386,
	"./fit/fit": 387,
	"./fit/fit.js": 387,
	"./fit/package": 388,
	"./fit/package.json": 388,
	"./fullscreen/fullscreen": 389,
	"./fullscreen/fullscreen.css": 414,
	"./fullscreen/fullscreen.js": 389,
	"./fullscreen/package": 390,
	"./fullscreen/package.json": 390,
	"./search/SearchHelper": 380,
	"./search/SearchHelper.js": 380,
	"./search/SearchHelper.js.map": 415,
	"./search/search": 391,
	"./search/search.js": 391,
	"./search/search.js.map": 416,
	"./terminado/package": 392,
	"./terminado/package.json": 392,
	"./terminado/terminado": 393,
	"./terminado/terminado.js": 393
};
...
(function (fit) {
  if (true) {
     ...
     * CommonJS environment
     */
    module.exports = fit(__webpack_require__(418));
  } else if (typeof define == 'function') {
    /*
     * Require.js is available
     */
